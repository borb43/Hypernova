...
HPR.StellarJoker {
    ...
    loc_vars = function (self, info_queue, card)
        ...
        return { vars = { G.playing_cards and math.max(#G.playing_cards, 2) or 52, card.ability.extra.emult_per, e,} }
    end,
    calculate = function (self, card, context)
        if context.joker_main or context.forcetrigger then
            local e = 1
...
HPR.StellarJoker {
    key = "hunter",
    config = { extra = { dollars = 5, eblindsize = 0.85 } },
    forcetrigger_compat = true,
    loc_vars = function (self, info_queue, card)
