...
HPR.vanilla_ascensions = { --ASCENSION LIST
    ...
    j_rough_gem = "j_hpr_prism",
    j_lusty_joker = "j_hpr_prideful",
    j_bloodstone = "j_hpr_prism",
    j_wrathful_joker = "j_hpr_prideful",
    j_arrowhead = "j_hpr_prism",
    j_gluttenous_joker = "j_hpr_prideful",
    j_onyx_agate = "j_hpr_prism",
    j_erosion = "j_hpr_void",
    j_ancient = "j_hpr_prism",
    j_flower_pot = "j_hpr_prideful",
    ...
    j_business = "j_hpr_royalty",
    j_baseball = "j_hpr_buffoon",
    j_luchador = "j_hpr_hunter",
    j_matador = "j_hpr_hunter",
    j_hallucination = "j_hpr_boosted",
    j_hit_the_road = "j_hpr_royalty",
    j_reserved_parking = "j_hpr_royalty",
    j_red_card = "j_hpr_boosted",
    j_acrobat = "j_hpr_guardian",
    j_dusk = "j_hpr_guardian",
    j_abstract = "j_hpr_buffoon",
    j_mime = "j_hpr_storm",
    j_hanging_chad = "j_hpr_storm",
    j_loyalty_card = "j_hpr_guardian",
    j_fibonacci = "j_hpr_numeric",
    j_burglar = "j_hpr_circus",
    j_ticket = "j_hpr_enchant",
    j_lucky_cat = "j_hpr_enchant",
