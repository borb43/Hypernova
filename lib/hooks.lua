...
create_card = function(_type, area, legendary, _rarity, skip_materialize, soulable, forced_key, key_append)
	if next(SMODS.find_card("j_hpr_apostrophe_m")) and (SMODS.ConsumableTypes[_type] or _type == "Tarot_Planet") then
		_type = "Consumeables"
	end
...
function SMODS.is_eternal(card, trigger)
	if trigger and trigger.from_sell and card.ability.eternal and next(SMODS.find_card("j_hpr_destroyer")) then return false end
